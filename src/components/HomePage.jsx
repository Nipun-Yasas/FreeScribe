...
export default function HomePage(props) {
  ...
  return (
    <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 justify-center pb-20'> 
        ...
        <button onClick={recordingStatus==='recording'? stopRecording:startRecording} className='specialBtn px-4 py-2 rounded-xl flex items-center text-base justify-between gap-4 mx-auto w-72 max-w-full my-4'>
            ...
            <div className='flex items-center gap-2'>
              {duration && (<p className='text-sm'>{duration} sec</p>)}
              </div>
        ...
        <p className='italic text-slate-400'>Free now and free forever</p>
    </main>
  )
}
